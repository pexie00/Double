    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        if is_valid == True:
            if fileid == "send_all":
                ...
                return
            btn = [[
                InlineKeyboardButton("🚀 Get File You requested 🚀", url=f"https://telegram.me/{temp.U_NAME}?start=files_{fileid}")
            ]]
            await message.reply_photo(
                photo="https://telegra.ph/file/c4cca8558c3f881d2afbf.jpg",
                caption=f"<b>ʜᴇʏ {message.from_user.mention}, \n ʏᴏᴜ ᴀʀᴇ sᴜᴄᴄᴇssғᴜʟʟʏ ᴠᴇʀɪғɪᴇᴅ ! \nɴᴏᴡ ʏᴏᴜ ʜᴀᴠᴇ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇss ғᴏʀ ᴀʟʟ ᴍᴏᴠɪᴇs ꜰᴏʀ 36 ʜᴏᴜʀꜱ ꜰʀᴏᴍ ɴᴏᴡ. 😎</b>",
    ...
    if not files_:
        ...
        try:
            if IS_VERIFY and not await check_verification(client, message.from_user.id):
                ...
                await message.reply_photo(
                    photo="https://telegra.ph/file/8528989260354807d46bc.jpg",

...
from utils import get_settings, get_size, is_subscribed, temp,verify_new, verify_VIP save_group_settings, temp, verify_user, check_token, check_verification, get_token, send_all, get_readable_time, get_wish, is_check_admin
...
async def start(client, message):
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        ...
        await message.reply_photo(
            photo=random.choice(PICS),
            caption=script.START_TXT.format(message.from_user.mention, temp.U_NAME, temp.B_NAME, get_wish()),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
        return
        ...
        if is_valid == True:
            if fileid == "send_all":
                ...
                await message.reply_photo(
                    ...
                    caption=f"<b>ʜᴇʏ {message.from_user.mention},\n ʏᴏᴜ ᴀʀᴇ sᴜᴄᴄᴇssғᴜʟʟʏ ᴠᴇʀɪғɪᴇᴅ ! \n ɴᴏᴡ ʏᴏᴜ ʜᴀᴠᴇ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇss ғᴏʀ ᴀʟʟ ᴍᴏᴠɪᴇs ꜰᴏʀ 36 ʜᴏᴜʀꜱ ꜰʀᴏᴍ ɴᴏᴡ. 😎</b>",
                    reply_markup=InlineKeyboardMarkup(btn)
                )
                return
            btn = [[
                InlineKeyboardButton("Get File You requested before..! 🚀", url=f"https://telegram.me/{temp.U_NAME}?start=files_{fileid}")
            ]]
            await message.reply_photo(
                photo="https://telegra.ph/file/e5a72c75e349ebba4b35f.jpg",
                caption=f"<b>ʜᴇʏ {message.from_user.mention}, \n ʏᴏᴜ ᴀʀᴇ sᴜᴄᴄᴇssғᴜʟʟʏ ᴠᴇʀɪғɪᴇᴅ ! \nɴᴏᴡ ʏᴏᴜ ʜᴀᴠᴇ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇss ғᴏʀ ᴀʟʟ ᴍᴏᴠɪᴇs ꜰᴏʀ 36 ʜᴏᴜʀꜱ ꜰʀᴏᴍ ɴᴏᴡ. 😎</b>",
    ...
    if not files_:
        ...
        try:
            if IS_VERIFY and not await check_verification(client, message.from_user.id):
                ...
                await message.reply_photo(
                    photo="https://telegra.ph/file/e5a72c75e349ebba4b35f.jpg",
                    caption=f"<b>ʜᴇʟʟᴏ {message.from_user.mention}, ʏᴏᴜʀ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪғɪᴇᴅ ᴛᴏᴅᴀʏ,ᴘʟᴇᴀꜱᴇ ᴠᴇʀɪғʏ ɴᴏᴡ ᴀɴᴅ ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇꜱꜱ ғᴏʀ ɴᴇxᴛ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ [36 ʜᴏᴜʀꜱ]...\nइस बाॅट को इस्तेमाल करने के लिए आपको ᴠᴇʀɪғʏ करना होगा नहीं तो आप इसका इस्तेमाल नहीं कर पाएंगे ! 😁</b>",
                    reply_markup=InlineKeyboardMarkup(btn)
                )
                return

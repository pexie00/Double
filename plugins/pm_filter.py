        ...
        if k == False:
            ...
            if files:
                ...
                if NO_RESULTS_MSG:
                    ...
                    await bot.send_message(chat_id=LOG_CHANNEL, text=(script.NORSLTS.format(message.chat.title, message.chat.id, total, temp.B_NAME, reqstr.mention, movie)), reply_markup=InlineKeyboardMarkup(safari))

...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sttrackstudio:sttrackstudio@cluster0.iq6pji7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002459285518').split()]
